...
import static seedu.address.logic.commands.CommandTestUtil.REMARK_DESC_FRIEND;
import static seedu.address.logic.commands.CommandTestUtil.REMARK_DESC_HUSBAND;
import static seedu.address.logic.commands.CommandTestUtil.VALID_ADDRESS_BOB;
import static seedu.address.logic.commands.CommandTestUtil.VALID_EMAIL_BOB;
import static seedu.address.logic.commands.CommandTestUtil.VALID_NAME_BOB;
import static seedu.address.logic.commands.CommandTestUtil.VALID_PHONE_BOB;
import static seedu.address.logic.commands.CommandTestUtil.VALID_REMARK_FRIEND;
import static seedu.address.logic.commands.CommandTestUtil.VALID_REMARK_HUSBAND;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withRemarks(VALID_REMARK_FRIEND).build();

        // whitespace only preamble
        assertParseSuccess(parser,
                           PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + INCOME_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + FAMILY_DESC_BOB + REMARK_DESC_FRIEND, new AddCommand(expectedPerson));


        // multiple tags - all accepted
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withRemarks(VALID_REMARK_FRIEND,
                        VALID_REMARK_HUSBAND)
                .build();
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + INCOME_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + FAMILY_DESC_BOB
                        + REMARK_DESC_HUSBAND + REMARK_DESC_FRIEND,
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + INCOME_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + FAMILY_DESC_BOB + REMARK_DESC_FRIEND;
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Person expectedPerson = new PersonBuilder(AMY).withRemarks().build();
        assertParseSuccess(parser,
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser,
                           INVALID_NAME_DESC + PHONE_DESC_BOB + INCOME_DESC_BOB + EMAIL_DESC_BOB
                                   + ADDRESS_DESC_BOB + FAMILY_DESC_BOB
                                   + REMARK_DESC_HUSBAND + REMARK_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser,
                           NAME_DESC_BOB + INVALID_PHONE_DESC + INCOME_DESC_BOB + EMAIL_DESC_BOB
                                   + ADDRESS_DESC_BOB + FAMILY_DESC_BOB
                                   + REMARK_DESC_HUSBAND + REMARK_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser,
                           NAME_DESC_BOB + PHONE_DESC_BOB
                                   + INCOME_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB + FAMILY_DESC_BOB
                                   + REMARK_DESC_HUSBAND + REMARK_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser,
                           NAME_DESC_BOB + PHONE_DESC_BOB + INCOME_DESC_BOB
                                   + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + FAMILY_DESC_BOB
                                   + REMARK_DESC_HUSBAND + REMARK_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid remark
        assertParseFailure(parser,
                           NAME_DESC_BOB + PHONE_DESC_BOB + INCOME_DESC_BOB
                                   + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + FAMILY_DESC_BOB
                                   + INVALID_REMARK_DESC + VALID_REMARK_FRIEND, Remark.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser,
                ...
                + ADDRESS_DESC_BOB + FAMILY_DESC_BOB + REMARK_DESC_HUSBAND + REMARK_DESC_FRIEND,
