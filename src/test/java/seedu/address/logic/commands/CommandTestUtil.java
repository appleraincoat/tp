...
public class CommandTestUtil {
    ...
    public static final String TAG_DESC_FRIEND = " " + PREFIX_REMARKS + VALID_TAG_FRIEND;
    public static final String TAG_DESC_HUSBAND = " " + PREFIX_REMARKS + VALID_TAG_HUSBAND;
    ...
    public static final String INVALID_TAG_DESC = " " + PREFIX_REMARKS + "hubby*"; // '*' not allowed in tags
